...
/****** Object:  StoredProcedure [etl].[META_ETL1B_LOAD_SRC_TO_BASE3]    Script Date: 07/14/2012 08:54:56 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[etl].[META_ETL1B_LOAD_SRC_TO_BASE3]') AND type in (N'P', N'PC'))
DROP PROCEDURE [etl].[META_ETL1B_LOAD_SRC_TO_BASE3]
GO
...
truncate table base.aha1
select * from base.aha1
...
EXEC etl.[META_ETL1B_LOAD_SRC_TO_BASE] 'BARCLAY_CONTACT','Barclay_Contact.txt'
EXEC etl.[META_ETL1B_LOAD_SRC_TO_BASE3] 'AHA1','AHA.txt'
